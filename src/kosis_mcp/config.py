...
# 메타자료 종류 (개발가이드 p152~160)
META_TYPES = {
    "TBL": "통계표", "PRD": "수록주기", "CMMT": "주석", "SOURCE": "출처",
    "NCD": "분류", "ORG": "기관", "ITM": "항목", "UNIT": "단위", "WGT": "가중치",
}
...
ERROR_CODES = {
    ...
    "20": "필수요청변수 누락. 🔴 통계자료를 orgId/tblId 로 부를 때는 "
          "`/openapi/Param/statisticsParameterData.do` 를 써야 합니다 — "
          "`statisticsData.do` 로 보내면 항상 이 오류입니다(실측).",
